...
gains = df['Adj Close'].iloc[-1] - df['Adj Close'].iloc[0]
...
print('Largest gain for the SPY: {}'.format(df['Delta Adj Close'].sort_values(ascending=False).head(10))) 
...
print('Price of lowest adjusted closing: {}'.format(df.loc['2020', 'Adj Close'].min()))
...
print('Day with lowest adjusted closing: {}'.format(df.loc['2020', 'Adj Close'].idxmin()))
